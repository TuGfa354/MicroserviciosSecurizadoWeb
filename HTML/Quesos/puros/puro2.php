...
<head>
    <meta charset="UTF-8">
    <title>Queso Manchego Manzanares</title>
...
<body>
    ...
    <div class="banner">
        ...
        <h1>Queso Manchego Manzanares</h1>
        <p>Inicio → Quesos → Queso Manchego Manzanares</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Quesos/manchego.jpg" alt="Queso Manchego Manzanares">
            </div>
            <div class="texto">
                <p class="titulo">Queso Manchego Manzanares</p>
                <br>
                <p class="precio">5,50€</p>
                <br>
                <p class="kilos">16,46 €/kg</p>
                <br>
