...
<body>
    ...
    <div class="banner">
        <h1>Lomito Ibérico</h1>
        <p>Inicio → Quesos → Lomito Ibérico</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Quesos/lomitoib.webp" alt="Lomito Ibérico">
            </div>
            <div class="texto">
                <p class="titulo">Lomito Ibérico</p>
                <br>
                <p class="precio">28,00€</p>
                <br>
                <p class="kilos">54,90 €/kg</p>
                <br>
