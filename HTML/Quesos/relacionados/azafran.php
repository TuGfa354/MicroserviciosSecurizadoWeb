...
<body>
    ...
    <div class="banner">
        <h1>Azafrán 1g</h1>
        <p>Inicio → Quesos → Azafrán 1g</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Quesos/azafran.webp" alt="Azafrán 1g">
            </div>
            <div class="texto">
                <p class="titulo">Azafrán 1g</p>
                <br>
                <p class="precio">7,25€</p>
                <br>
                <p class="kilos">7,25 €/g</p>
                <br>
                ...
                <div class="select">
                    ...
                    <select name="seleccion" id="seleccion">
                        ...
                        <option value="2">5 gramos</option>
                    </select>
                </div>
