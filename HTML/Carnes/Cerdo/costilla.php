...
<body>
    ...
    <section data-product-id="15">
        ...
        <div class="producto">
            <div class="img">
                <img src="../../../img/Carnes/Cerdos/costilla-fresca-de-cerdo.webp" alt="Aguja de ternera">
            </div>
            <div class="texto">
                <p class="titulo">COstilla de cerdo</p>
                <br>
                <p class="precio">10,99€</p>
                <br>
                <p class="kilos">10,99 €/kg</p>
                <br>
