...
<body>
    ...
    ?>
    <div class="banner">
        <h1>Jamón de cerdo</h1>
        <p>Inicio → Carnicería → Jamón de cerdo</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img//Carnes/Cerdos/jamon-de-cerdo-fresco.webp" alt="Aguja de ternera">
            </div>
            <div class="texto">
                <p class="titulo">Jamón de cerdo</p>
                <br>
                <p class="precio">6.80-12.60€</p>
                <br>
                <p class="kilos">6.80-12.60 €/kg</p>
                <br>
