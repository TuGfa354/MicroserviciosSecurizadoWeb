...
<head>
    <meta charset="UTF-8">
    <title>Chuleta de lomo de cerdo</title>
...
<body>
    ...
    <div class="banner">
        <h1>Chuleta de lomo de cerdo</h1>
        <p>Inicio → Carnicería → Chuleta de lomo de cerdo</p>
    </div>
    <section data-product-id="10">

        <div class="producto">
            <div class="img">
                <img src="../../../img/Carnes/Cerdos/chuleta-de-lomo-de-cerdo-fresco.webp" alt="Aguja de ternera">
            </div>
            <div class="texto">
                <p class="titulo">Chuleta de lomo de cerdo</p>
                <br>
        ...
        <div class="populares">
            ...
            <div class="listapopulares">
                <div class="corte">
                    <div class="borde">
                        <div class="foto">
                            <a href="../Ternera/chuleton.php"><img src="../../../img/Carnes/Cerdos/chuleta-de-lomo-de-cerdo-fresco.jpg" title="Chuletón"></a>
                        </div>
