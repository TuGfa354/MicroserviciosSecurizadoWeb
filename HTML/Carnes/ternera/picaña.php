...
<?php include '../../header.php'; ?>
    <div class="banner">
        <h1>Picaña de ternera</h1>
        <p>Inicio → Carnes → Picaña de ternera</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Carnes/Ternera/picana-de-ternera.webp" alt="Picaña">
            </div>
            <div class="texto">
                <p class="titulo">Picaña de ternera</p>
                <br>
