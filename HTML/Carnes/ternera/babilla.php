...
<?php include '../../header.php'; ?>
    ...
    <div class="banner">
        <h1>Babilla de ternera</h1>
        <p>Inicio → Carnes → Babilla de ternera</p>
    </div>
    <section data-product-id="5">

        <div class="producto">
            <div class="img">
                <img src="../../../img/Carnes/Ternera/babilla-de-ternera.webp" alt="Babilla de ternera">
            </div>
            <div class="texto">
                <p class="titulo">Babilla de ternera</p>
                <br>
                <p class="precio">14,99€</p>
                <br>
                <p class="kilos">14,99 €/kg</p>
                <br>
