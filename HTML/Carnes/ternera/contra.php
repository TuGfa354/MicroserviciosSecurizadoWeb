...
<?php include '../../header.php'; ?>
    <div class="banner">
        <h1>Contra de ternera</h1>
        <p>Inicio → Carnes → Contra de ternera</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Carnes/Ternera/contra-de-ternera.webp" alt="Contra de ternera">
            </div>
            <div class="texto">
                <p class="titulo">Contra de ternera</p>
                <br>
