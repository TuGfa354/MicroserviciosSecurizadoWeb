...
<head>
    <meta charset="UTF-8">
    <title>Delicias de Panceta</title>
...
<?php include '../../header.php'; ?>
    ...
    <div class="banner">
        <h1>Delicias de Panceta</h1>
        <p>Inicio → Charcuteria → Delicias de Panceta</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Charcuteria/panceta1.webp" alt="Delicias de Panceta">
            </div>
            <div class="texto">
                <p class="titulo">Delicias de Panceta</p>
                <br>
                ...
                <div class="select">
                    ...
                    <select name="seleccion" id="seleccion">
                        ...
                        <option value="1">Docena entera</option>
                    </select>
                </div>
