...
<head>
    <meta charset="UTF-8">
    <title>Hamburguesa de pollo</title>
...
<body>
    ...
    <div class="banner">
        ...
        <p>Inicio → Pollería → Hamburguesa de pollo</p>
    </div>
    <section>

        <div class="producto">
            <div class="img">
                <img src="../../../img/Pollos/hamburguesa-de-pollo-300x300.jpg" alt="Hamburguesa de pollo">
            </div>
            <div class="texto">
                <p class="titulo">Hamburguesa de pollo</p>
                <br>
                <p class="precio">4,95€</p>
                <br>
                <p class="kilos">4,95 €/kg</p>
                <br>
